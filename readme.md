...
The LHTML Select tag also throws an event when using the `type` attribute that can be caught in any bundle. This can be used for various things like state, country selection, or a custom selection generated by your app.